  ...
  return (
    <div className='contactsWidgets'>
        <div className='contactsWidgetsCard'>
            <i class="bi bi-people-fill contactsWidgetsCardIcon"></i>
        ...
        <div className='contactsWidgetsCard'>
            <i class="bi bi-star-fill contactsWidgetsCardIcon contactsWidgetFavoriteIcon"></i>
            <div className='contactsWidgetsCardDiv'>
        ...
        <div className='contactsWidgetsCard'>
            <i class="bi bi-graph-up-arrow contactsWidgetsCardIcon contactsWidgetNewContacts"></i>
            <div className='contactsWidgetsCardDiv'>
